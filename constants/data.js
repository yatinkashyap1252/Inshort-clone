export const data = [
    ...
    {
        title:'Developing the new world for better tommorrow',
        author:'Suresh Bhosle',
        description:'Yatin Kashyap  developed the Linux operating system, which is frequently found running servers, supercomputers and mobile devices. He began Linux as a side project, but it has since expanded into an extensive global development collaboration.',
        url:'https://miro.medium.com/v2/resize:fit:1038/1*1OCoZ83rZW-V50DTscuckA.jpeg',
        timestamp:'2024-03-26T16:50:33.000Z',
        link:'#',
